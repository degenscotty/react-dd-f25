...
export function useMessageContract() {
  ...
  const { data: message, isLoading: isMessageLoading, refetch: refetchMessage } = useReadContract({
  ...
  const isLoading = isMessageLoading || isCountLoading || isWritePending || isConfirming || isPending;
